        ...
        if(error){
            ...
            $("a").each(function(index,value){
                ...
                if (isPageAnchor) {
                    ...
                    if(argv.verbose){
                        console.log(`Parse href: href was a # anchor tag. skipping: ${href}`);
                    }
                    return
                }
...
const runReport = function(urlList) {
    ...
    const lighthouseBatch = spawn('lighthouse-batch', ['-s', urlStringsCSV, '--html', '-v']);
...
if(argv.url){
    ...
    console.log('No site specified. Stopping. \nUse --help for more information.')
}
